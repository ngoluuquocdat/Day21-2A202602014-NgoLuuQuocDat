...
Tôi dùng AI (Claude Code) để: gỡ lỗi `No module named labkit` trên Colab, phát hiện và sửa lỗi checksum do CRLF, diễn giải verdict FAIL, và soạn khung REPORT. Chỗ cần cẩn thận: AI **suy ra** trường bị sai (urgency) từ `ft_pred` đã bị cắt ngắn trong `qualitative.json`, nên đó là suy luận gián tiếp chứ không phải đọc trực tiếp — tôi đã đối chiếu lại với nhãn đúng trong `eval_target.jsonl`. Bài học: dùng AI để tăng tốc gỡ lỗi và phân tích, nhưng **mọi con số cuối cùng phải tự kiểm chứng lại với file trong `results/`**.

**5. Nếu ngày mai phải fine-tune cho một khách hàng thật, bước đầu tiên bạn làm là gì?**
**Đóng băng một tập eval trước khi train**, và tập đó phải gồm cả nhiệm vụ đích **lẫn** một bộ câu hỏi phổ thông để bắt quên thảm hoạ — vì đó chính là thứ suýt qua mặt tôi hôm nay. Kèm theo, đo baseline prompt tối ưu trước, để biết fine-tune có thật sự đáng công so với chỉ prompt cho tử tế. Chỉ khi có mốc trung thực đó tôi mới bắt đầu train, và sẽ trộn sẵn 1–5% dữ liệu replay để phòng regression.
